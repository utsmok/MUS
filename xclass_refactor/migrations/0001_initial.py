# Generated by Django 5.0.6 on 2024-05-18 22:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("openalex_created_date", models.DateTimeField(null=True)),
                ...
                ("author_links", models.JSONField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("h_index", models.IntegerField()),
                ("i10_index", models.IntegerField()),
                ("apc_prices", models.JSONField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("jb_url", models.URLField(unique=True)),
                ("keywords", models.JSONField(null=True)),
                ("journal_title", models.CharField(unique=True)),
                ...
                ("openalex_issn", models.JSONField(null=True, unique=True)),
                ("openalex_issn_l", models.JSONField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("wikipedia", models.URLField(unique=True)),
        ...
        migrations.AddField(
            ...
            name="topics",
            field=models.ManyToManyField(
                related_name="organizations", to="xclass_refactor.topic"
            ),
        ),
        migrations.AddField(
            model_name="author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("cited_by_count", models.IntegerField(null=True)),
                ("cited_by_percentile_year", models.JSONField(null=True)),
                ...
                ("mesh_terms", models.JSONField(null=True)),
                ...
                ("keywords", models.JSONField(null=True)),
                ("sdgs", models.JSONField(null=True)),
                ("versions", models.JSONField(null=True)),
                ("found_in_institute_repo", models.BooleanField(default=False)),
                ("repo_keywords", models.JSONField(null=True)),
