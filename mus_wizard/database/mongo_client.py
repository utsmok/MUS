...
class MusMongoClient:
    ...
    def __init__(self):
        ...
        self.institutions_openalex : motor.motor_asyncio.AsyncIOMotorCollection = self.mongoclient['institutions_openalex']
        ...
        self.items_semantic_scholar : motor.motor_asyncio.AsyncIOMotorCollection = self.mongoclient['items_semantic_scholar']
